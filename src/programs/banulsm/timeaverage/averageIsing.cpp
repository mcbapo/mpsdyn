...
int main(int argc,const char* argv[]){
  ...
  //    _rightEV.exportMPStext("/home/banulsm/SVN/peps/projects/mpsdyn/src/bin/rightEV.txt");
  //    _leftEV.exportMPStext("/home/banulsm/SVN/peps/projects/mpsdyn/src/bin/leftEV.txt");
  //  }
     double lambda=0;
