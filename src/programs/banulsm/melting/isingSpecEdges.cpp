...
int main(int argc,const char* argv[]){
  ...
  string mpsfile=getMPSfilename(L,J,g,h,1); // basename of MPS files
  string tmpMPSfile;
  ...
  *out<<endl;
  ...
  double Emax=0;
  MPS exc(L,D,d);
  string mpsfile1=getMPSfilename(L,J,g,h,0); // basename of MPS files
  string tmpMPSfile1;
