...
//#define APPLYKICK 1
#define TILT 1
/** bosehubSolitonDynMomTrap finds the ground state of the Bose-Hubbard
    ...
    In this case, after creating the soliton, a harmonic potential,
    centered in the middle of the system, is included, 
    to see if the soliton oscillates in space, as the classical case.
