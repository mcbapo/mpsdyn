/**
   \file SHGIGaussLawAngular_test_seq.cpp
   ...
   Compared to SHGIGaussLawAngular_test.cpp this version does not read the groundstate of a previous run from disk but takes the one which is already in the memory from the previous run.
