...
public:
    ...
    */
    ...
    /** Operator Sz^2, summing up only spins of even or odd sites */
    static void getSz2EvenMPO(int L, int spindim, MPO &Sz2Even);
    static void getSz2OddMPO(int L, int spindim, MPO &Sz2Odd);
