...
#ifndef SH_NUMBER_OPERATOR_H
#define SH_NUMBER_OPERATOR_H

#include "MPS.h"
#include "Hamiltonian.h"

/** 
    Implementation of the Schwinger Hamiltonian in the spin representation with simplified gauge fields that violate the gauge invariance of the Hamiltonian. This version employs \f$ L(n) = a_n^\dagger a_n \f$ and omits the \f$ \theta(n) \f$ 

*/

class SHNumberOperator: 
public Hamiltonian{
protected:
  int N_fermions;
  int N_total;
  ...
  */
  SHNumberOperator(int N,int d,int D,double mu,double x,double e,double lambda);
