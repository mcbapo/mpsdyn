/**
   \file SchwingerHamiltonianAGIGaussLaw.h
...
#ifndef SCHWINGER_HAMILTONIAN_AGI_GAUSSLAW_H
#define SCHWINGER_HAMILTONIAN_AGI_GAUSSLAW_H
...
/** 
    ...
    By contrast to the other versions the exponential is approximated by its Taylor series up to the order given by the user therefore controlling of the level of gauge invariance is possible

*/

class SchwingerHamiltonianAGIGaussLaw: 
public Hamiltonian{
protected:
  int N_fermions;
  int N_total;
  ...
  */
  SchwingerHamiltonianAGIGaussLaw(int N,int d,int D,double mu,double x,double e,double lambda, unsigned int exp_order);
  
  ~SchwingerHamiltonianAGIGaussLaw();
