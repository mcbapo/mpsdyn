/**
   \file SchwingerHamiltonianNGIGaussLaw.h
...
#ifndef SCHWINGER_HAMILTONIAN_NGI_GAUSSLAW_H
#define SCHWINGER_HAMILTONIAN_NGI_GAUSSLAW_H
...
class SchwingerHamiltonianNGIGaussLaw: 
public Hamiltonian{
protected:
  int N_fermions;
  int N_total;
  ...
  */
  SchwingerHamiltonianNGIGaussLaw(int N,int d,int D,double mu,double x,double e,double lambda);
  
  ~SchwingerHamiltonianNGIGaussLaw();
