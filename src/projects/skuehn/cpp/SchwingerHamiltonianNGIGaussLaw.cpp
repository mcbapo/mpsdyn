#include "SchwingerHamiltonianNGIGaussLaw.h"
#include "Indices.h"
...
SchwingerHamiltonianNGIGaussLaw::SchwingerHamiltonianNGIGaussLaw(int N_, int d_,int D_,double mu_,double x_,double e_,double lambda_):hamil(2*N_-1),charge(2*N_-1)
{
  N_fermions = N_;
...
//Destructor
SchwingerHamiltonianNGIGaussLaw::~SchwingerHamiltonianNGIGaussLaw(){
    hamil.clear();
    charge.clear();    
}

void SchwingerHamiltonianNGIGaussLaw::initOperators()
{
  ...
  cout << hamil << endl;
  hamil.exportForMatlab("HPenalty.m");
}// initOperators

void SchwingerHamiltonianNGIGaussLaw::initChargeoperator()
{
...
void SchwingerHamiltonianNGIGaussLaw::constructLopMPO(MPO &mpo, int n)
{
...
void SchwingerHamiltonianNGIGaussLaw::constructGaussMPO(MPO &mpo, int n)
{
...
void SchwingerHamiltonianNGIGaussLaw::constructsigmazMPO(MPO &mpo, int n)
{
...
void SchwingerHamiltonianNGIGaussLaw::constructCondensateMPO(MPO &mpo)
{
...
void SchwingerHamiltonianNGIGaussLaw::constructPenaltyMPO(MPO &mpo)
{
