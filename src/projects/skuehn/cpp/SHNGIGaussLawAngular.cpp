...
SHNGIGaussLawAngular::SHNGIGaussLawAngular(int N_, int d_,int D_,double mu_,double x_,double e_,double lambda_):hamil(2*N_-1),charge(2*N_-1)
{
  N_fermions = N_;
  ...
  cout << "Constructing NON gauge invariant Hamiltonian with " << endl
...
//Destructor
SHNGIGaussLawAngular::~SHNGIGaussLawAngular(){
    hamil.clear();
    charge.clear();    
}

void SHNGIGaussLawAngular::initOperators()
{
  ...
  Op1 = identityMatrix(this->d_bose) + I_c*Theta;
  Op2 = identityMatrix(this->d_bose) - I_c*Theta;
  ...
  //cout << hamil << endl;
  //hamil.exportForMatlab("HSHNGIGaussLawAngular.m");
}// initOperators

void SHNGIGaussLawAngular::initChargeoperator()
{
...
void SHNGIGaussLawAngular::constructLopMPO(MPO &mpo, int n)
{
  ...
  if((n%2)!=1)
  {
    cerr << "Error in SHNGIGaussLawAngular::constructLopMPO(MPO &mpo, int n): Index " << n << " is not a valid bosonic site" << endl;
    exit(1);
  }
...
void SHNGIGaussLawAngular::constructGaussMPO(MPO &mpo, int n)
{
  ...
  if((n%2)==1)
  {
    cerr << "Error in SHNGIGaussLawAngular::constructGaussMPO(MPO &mpo, int n): Index " << n << " is not a valid fermionic site" << endl;
    exit(1);
  }
...
void SHNGIGaussLawAngular::constructsigmazMPO(MPO &mpo, int n)
{
  ...
  if((n%2)==1)
  {
    cerr << "Error in SHNGIGaussLawAngular::constructsigmazMPO(MPO &mpo, int n): Index " << n << " is not a valid fermionic site" << endl;
    exit(1);
  }
...
void SHNGIGaussLawAngular::constructCondensateMPO(MPO &mpo)
{
...
void SHNGIGaussLawAngular::constructPenaltyMPO(MPO &mpo)
{
