...
SHNumberOperator::SHNumberOperator(int N_, int d_,int D_,double mu_,double x_,double e_,double lambda_):hamil(2*N_-1),charge(2*N_-1)
{
  N_fermions = N_;
...
//Destructor
SHNumberOperator::~SHNumberOperator(){
    hamil.clear();
    charge.clear();    
}

void SHNumberOperator::initOperators()
{
  ...
  cout << hamil << endl;
  hamil.exportForMatlab("HSHNumberOperator.m");
}// initOperators

void SHNumberOperator::initChargeoperator()
{
...
void SHNumberOperator::constructLopMPO(MPO &mpo, int n)
{
  ...
  if((n%2)!=1)
  {
    cerr << "Error in SHNumberOperator::constructLopMPO(MPO &mpo, int n): Index " << n << " is not a valid bosonic site" << endl;
    exit(1);
  }
...
void SHNumberOperator::constructGaussMPO(MPO &mpo, int n)
{
  ...
  if((n%2)==1)
  {
    cerr << "Error in SHNumberOperator::constructGaussMPO(MPO &mpo, int n): Index " << n << " is not a valid fermionic site" << endl;
    exit(1);
  }
...
void SHNumberOperator::constructsigmazMPO(MPO &mpo, int n)
{
  ...
  if((n%2)==1)
  {
    cerr << "Error in SHNumberOperator::constructsigmazMPO(MPO &mpo, int n): Index " << n << " is not a valid fermionic site" << endl;
    exit(1);
  }
...
void SHNumberOperator::constructCondensateMPO(MPO &mpo)
{
...
void SHNumberOperator::constructPenaltyMPO(MPO &mpo)
{
