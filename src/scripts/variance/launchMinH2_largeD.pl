...
my $EXEC="./minH2";
my $par="-P 10"; # use parallel environment

my $basicDir="/ptmp/mpq/banulsm/variance/Ising/Dlarge";
...
my @hamilPars=(" 1 -1.05 0.5"," 1 0.905 0.809"," 1 0.8 0");
my @idStrings=("J1_gm105_h05","J1_g0905_h0809","J1_g08_h0");
...
foreach $paramSet (@hamilPars){
	...
	my $mpsfile="${mpsDir}/${strL}/mps_${suffix}";
	...
	my $args=" ${N} ${paramSet} ${D1} ${D2} ${incrD} ${outfile} ${app} ${mpsfile}";
