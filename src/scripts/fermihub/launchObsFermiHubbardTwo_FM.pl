...
my $scriptFile="lanzaObs_FMfactors.sh";
...
#my @factors=(0.75,1.15,1.5);
#my @factors=(0.3,0.5,0.75,1.15,1.5,1.75,2,3);
my @factors=(0.3,0.5,0.75,1,1.15,1.5,1.75,2,3);$MAXD=300;
#my @factors=(1.15,1.5,1.75,2,3);$MAXD=300;
...
my $MULTIIMB=0;
#$L=24; my @Ngs=(0.4*$L..0.6*$L);
#my @Nes=(0.65*$L..0.85*$L);
$L=12;my @Ngs=(0..$Nmax);my @Nes=(0..$L);
