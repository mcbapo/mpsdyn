...
#my @Vs=(9..10);my $tryVsstep=.2;my $refine=1;
#my @Vs=(11..13);my $tryVsstep=1;my $refine=1;
my $D=180; my $MAXD=200;
my @Vs=(5.2,5.4,5.6,5.8);my $tryVsstep=.2;my $refine=1;
my @Vs=(6.2,6.6);my $tryVsstep=.2;my $refine=0;
#my @Vs=(6.2,6.4,6.6,6.8);my $tryVsstep=.2;my $refine=1;
...
my @Ns=(0..$Ntot/2+10);
my @Ns=(0..33);
#my @Ns=(12); my @Vs=(8.8);my $D=140;my $maxD=140;my $refine=0;
#my @Ns=(0..$Ntot);
