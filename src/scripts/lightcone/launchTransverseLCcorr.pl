...
$basicdir="/ptmp/mpq/banulsm/TransverseLCop/Ising/restartCorropt/";
$basictmpdir="/ptmp/mpq/banulsm/TransverseLCop/IsingTmp/restartCorropt/";
$truncH="-truncH=0"; # NO truncation a la HAstings

$jobStr="tlc_all"; # Name of running jobs
$prefixFile="corr";
$computeAll=1; 
$computeE=0; #$prefixFile="${prefixFile}E"; $jobStr="${jobStr}E";
...
my $scriptfile="corrAll_truncStd.sh";
