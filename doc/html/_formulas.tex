...
\[ H=- \sum_i t_i (b_i^{\dagger} b_{i+1} + h.c.) + \sum_i \frac{U_i}{2} n_i (n_i-1) \sum_i V_i n_i +\lambda_N \left(\sum_i n_i-N_{\mathrm{target}}\right)^2 \]
\pagebreak

\[ h_{pos,pos+1}=-t_{pos} (b_{pos}^{\dagger} b_{pos+1} + h.c.) + \frac{U_{pos}}{2} n_{pos} (n_{pos}-1) + \frac{U_{pos+1}}{2} n_{pos+1} (n_{pos+1}-1) \frac{V_{pos}-\mu_{pos}}{2} n_{pos} + \frac{V_{pos+1}-\mu_{pos+1}}{2} n_{pos+1} \]
\pagebreak
...
$\rho_{1/2}=\left ( \frac{Id}{\sqrt{d}}\right )^{\otimes L-L_0} \otimes |\phi_0\rangle \langle \phi_0| $
\pagebreak
...
$\rho_{1/2}= |\phi_0\rangle \langle \phi_0| \otimes \left ( \frac{Id}{\sqrt{d}}\right )^{\otimes L-L_0}$
\pagebreak
...
\[H_{\mathrm{QF}}=\frac{1}{2}\omega_{\mathrm{q}} \sigma_{\mathrm{q}}^z + \frac{1}{2}\epsilon \sigma_{\mathrm{f}}^z +\frac{1}{2}\Delta \sigma_{\mathrm{f}}^x+ \frac{1}{2}v \sigma_{\mathrm{q}}^z\otimes \sigma_{\mathrm{f}}^z \]
\pagebreak
...
$C_{\alpha_1 \ldots \alpha_k}$
\pagebreak

\[ \sum_n f(n) \sigma_{\alpha_1} \ldots \sigma_{\alpha_k} \]
\pagebreak

\[ \frac{d\rho}{d t}=i[\rho,H]+\sum_{\alpha}\gamma_{\alpha}\left( L_{\alpha} \rho L_{\alpha}^{\dagger}-\frac{1}{2} \rho L_{\alpha}^{\dagger} L_{\alpha} -\rho L_{\alpha}^{\dagger} L_{\alpha} \rho\right), \]
\pagebreak
...
\[ \frac{d\rho}{d t}=i[\rho,H]+\gamma \left( L \rho L^{\dagger}-\frac{1}{2} \rho L^{\dagger} L -\rho L^{\dagger} L \rho\right), \]
\pagebreak
...
\begin{eqnarray*} W_0 &=& \sum_n L^2(n) + \frac{\mu}{2}\sum_n(-1)^n\sigma_3(n)+N\frac{\mu}{2}\\ V &=& \sum_n\left[\sigma^+(n)(1+i\theta(n))\sigma1^-(n+1) + \sigma^+(n+1)(1-i\theta(n))\sigma1^-(n)\right] \\ \end{eqnarray*}
\pagebreak
